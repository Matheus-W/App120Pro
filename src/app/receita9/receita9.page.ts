...
@Component({
  selector: 'app-receita9',
  templateUrl: './receita9.page.html',
  styleUrls: ['./receita9.page.scss'],
})
export class Receita9Page implements OnInit {
  ...
  ngOnInit() {
    this.usuarioService.Post('%9', 'Receita/')
      .then((response)=>{
  ...
  PegaProduto(numero, Nome, valor){
    ...
    let resposta;
      this.EnviaDadosDeReceita = '(;' + '9' + ';' + this.Dados[0] + ';' + this.Dados[1] + ';' + this.Dados[2] +';' + this.Dados[3] + ';' + this.Dados[4] + ';' + this.Dados[5] + ';' + this.Dados[6] + ';' + this.Dados[7] + ';' + this.Dados[8] + ';' + this.Dados[9] + ';^';
