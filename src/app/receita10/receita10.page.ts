...
@Component({
  selector: 'app-receita10',
  templateUrl: './receita10.page.html',
  styleUrls: ['./receita10.page.scss'],
})
export class Receita10Page implements OnInit {
  ...
  ngOnInit() {
    this.usuarioService.Post('%0', 'Receita/')
      .then((response)=>{
  ...
  PegaProduto(numero, Nome, valor){
    ...
    let resposta;
      this.EnviaDadosDeReceita = '(;' + '10' + ';' + this.Dados[0] + ';' + this.Dados[1] + ';' + this.Dados[2] +';' + this.Dados[3] + ';' + this.Dados[4] + ';' + this.Dados[5] + ';' + this.Dados[6] + ';' + this.Dados[7] + ';' + this.Dados[8] + ';' + this.Dados[9] + ';^';
