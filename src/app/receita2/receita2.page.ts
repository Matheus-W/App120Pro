...
@Component({
  selector: 'app-receita2',
  templateUrl: './receita2.page.html',
  styleUrls: ['./receita2.page.scss'],
})
export class Receita2Page implements OnInit {
      ...
      ngOnInit() {
        this.usuarioService.Post('%2', 'Receita/')
          .then((response)=>{
      ...
      PegaProduto(numero, Nome, valor){
        ...
        let resposta;
          this.EnviaDadosDeReceita = '(;' + '2' + ';' + this.Dados[0] + ';' + this.Dados[1] + ';' + this.Dados[2] +';' + this.Dados[3] + ';' + this.Dados[4] + ';' + this.Dados[5] + ';' + this.Dados[6] + ';' + this.Dados[7] + ';' + this.Dados[8] + ';' + this.Dados[9] + ';^';
